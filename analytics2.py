...
def write_to_csv_departments2(time,q1,q1s,q2,q2s,q3,q3s,q4,q4s,q5,q5s,q6,q6s,q7,q7s,q8,q8s):
                

    with open('dataset/database2.csv', 'r') as f:
        reader = csv.reader(f)
        for header in reader:
            break
    with open('dataset/database2.csv', "a", newline='') as f:
